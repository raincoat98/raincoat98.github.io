...
title: Chrome Extension MV3 Firebase Google 로그인 구현 — OAuth 새 탭 흐름
description: Chrome Extension Manifest V3에서 Firebase Google OAuth 로그인 구현 방법. CSP 제약으로 인한 스크립트 실행 불가 문제를 새 탭 기반 OAuth 흐름으로 해결합니다.
created: 2025-11-21
